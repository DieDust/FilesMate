...
| Product screenshots | Actual 1.1.81 UI with synthetic files in a separate test profile; `docs/images` | Project documentation assets; no personal documents used |
