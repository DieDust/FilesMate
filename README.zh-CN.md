<div align="center">
  ...
  <h1>FilesMate</h1>
  <p>原生 Windows 文件管理器，让浏览、查找、预览与整理在一个地方完成。</p>
...
FilesMate 不仅用来打开文件夹，也照顾整理文件时的那些小步骤：两个目录并排处理，把不同位置的文件先收进暂存架，批量改名前先看结果，关闭主窗口后仍能随时唤起搜索。
...
这里是**文件名搜索**，不是文档全文搜索。索引范围由你选择，索引的建立和更新由文件管理器负责。
